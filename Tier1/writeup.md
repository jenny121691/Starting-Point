...
### 🗄️ Process of solving task5

1. Use nmap to scan the target machine (10.129.119.152).
   
   ```bash
   nmap -sV -Pn --min-rate 1000 -oN scan.txt 10.129.119.152
   ```
